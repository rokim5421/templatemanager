...
<html>
<head>
	<title>Section Template Preview</title>
...
$(document).ready(function() {
   $('#btn-proses').click(function() {
    ...
    for (var x=1;x<jml+1;x++){
     ...
     $.ajax({
            type: 'get', 
          url: 'tools/screenshot-persec.php',
         data: 'template='+body, 
         success: function(response) { 
...
$(document).ready(function() {
   $('#btn-download').click(function() {
    ...
    for (var x=1;x<jml+1;x++){
     ...
     body = body.replace(/^,|,$/g,'');
     var url = 'tools/json-persec.php?&template='+body+'&nama='+nama_template; 
     window.location = url;
     //console.log(url);
   } else {
